        ...
        const mockPatients = [
          {
            ...
            medicalHistory: [
              ...
              { condition: "Migraine", diagnosedDate: "2018-06-22", notes: "Occasional episodes, triggers identified" }
            ],
            medications: [
              { name: "Lisinopril", dosage: "10mg", frequency: "Once daily", startDate: "2020-03-15" },
              { name: "Sumatriptan", dosage: "50mg", frequency: "As needed", startDate: "2018-07-10" }
            ],
          ...
          },
          {
            ...
            medicalHistory: [
              { condition: "Coronary Artery Disease", diagnosedDate: "2019-11-05", notes: "Stent placed in 2019" },
              { condition: "Type 2 Diabetes", diagnosedDate: "2017-04-18", notes: "Diet controlled" }
            ],
            medications: [
              { name: "Aspirin", dosage: "81mg", frequency: "Once daily", startDate: "2019-11-05" },
              { name: "Atorvastatin", dosage: "20mg", frequency: "Once daily", startDate: "2019-11-05" },
              { name: "Metformin", dosage: "500mg", frequency: "Twice daily", startDate: "2017-04-18" }
            ],
          ...
          },
          {
            ...
            medicalHistory: [
              { condition: "Anxiety", diagnosedDate: "2021-02-10", notes: "Mild, managed with therapy" }
            ],
            medications: [
              { name: "Escitalopram", dosage: "10mg", frequency: "Once daily", startDate: "2021-02-10" }
            ],
            allergies: []
          },
          {
            ...
            medicalHistory: [
              { condition: "Atrial Fibrillation", diagnosedDate: "2015-09-30", notes: "Paroxysmal" },
              { condition: "Hypertension", diagnosedDate: "2010-05-12", notes: "Well-controlled with medication" },
              { condition: "Osteoarthritis", diagnosedDate: "2018-11-20", notes: "Affecting knees" }
            ],
            medications: [
              { name: "Warfarin", dosage: "5mg", frequency: "Once daily", startDate: "2015-09-30" },
              { name: "Metoprolol", dosage: "25mg", frequency: "Twice daily", startDate: "2015-09-30" },
              { name: "Hydrochlorothiazide", dosage: "12.5mg", frequency: "Once daily", startDate: "2010-05-12" },
              { name: "Acetaminophen", dosage: "500mg", frequency: "As needed", startDate: "2018-11-20" }
            ],
          ...
          },
          {
            ...
            medicalHistory: [
              { condition: "Asthma", diagnosedDate: "2005-03-18", notes: "Exercise-induced" },
              { condition: "Seasonal Allergies", diagnosedDate: "2008-05-22", notes: "Spring and fall" }
            ],
            medications: [
              { name: "Albuterol", dosage: "90mcg", frequency: "As needed", startDate: "2005-03-18" },
              { name: "Fluticasone", dosage: "50mcg", frequency: "Once daily", startDate: "2005-03-18" },
              { name: "Cetirizine", dosage: "10mg", frequency: "Once daily", startDate: "2008-05-22" }
            ],
          ...
          },
          {
            ...
            medicalHistory: [
              { condition: "Arrhythmia", diagnosedDate: "2022-01-15", notes: "Premature ventricular contractions" }
            ],
            medications: [
              { name: "Propranolol", dosage: "10mg", frequency: "Twice daily", startDate: "2022-01-15" }
            ],
            allergies: ["Latex"]
          }
        ];
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          ...
                          <div className="text-sm text-gray-500">{patient.id} • {patient.age} yrs • {patient.gender}</div>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
            ...
            <div className="px-6 py-4">
              ...
              <div className="flex items-start mb-6">
                ...
                <div className="ml-6">
                  ...
                  <p className="text-gray-500">{selectedPatient.id} • {selectedPatient.age} years • {selectedPatient.gender}</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="border border-gray-200 rounded-lg p-4">
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="px-2 py-1 text-xs rounded-full bg-green-100 text-green-800">Scheduled</span>
                    </div>
                    <p className="text-sm font-medium text-gray-900">{new Date(selectedPatient.nextAppointment).toLocaleDateString()}</p>
                  </div>
                </div>
              </div>
              ...
              {/* Medical History */}
              <div className="mb-6">
                <h4 className="text-sm font-medium text-gray-500 mb-3">Medical History</h4>
              ...
              {/* Medications */}
              <div className="mb-6">
                <h4 className="text-sm font-medium text-gray-500 mb-3">Current Medications</h4>
              ...
              {/* Allergies */}
              <div className="mb-6">
                <h4 className="text-sm font-medium text-gray-500 mb-3">Allergies</h4>
