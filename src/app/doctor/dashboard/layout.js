  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex">
        ...
        <div className={`${isSidebarOpen ? 'block' : 'hidden'} md:block md:w-64 bg-white shadow-md h-[calc(100vh-4rem)] fixed overflow-y-auto`}>
          <div className="p-4">
            <nav className="space-y-1">
              ...
              <Link href="/doctor/dashboard/feedback" 
              ...
              <Link href="/doctor/dashboard/patients" 
                className={`group flex items-center px-3 py-3 text-sm font-medium rounded-md ${isActive('/patients')}`}>
                <svg xmlns="http://www.w3.org/2000/svg" className="mr-3 h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
              ...
              <div className="pt-4 mt-4 border-t border-gray-200">
                <Link href="/login" 
                  className="group flex items-center px-3 py-3 text-sm font-medium rounded-md text-red-600 hover:bg-red-50 hover:text-red-700">
                  <svg xmlns="http://www.w3.org/2000/svg" className="mr-3 h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
        ...
        {/* Main Content */}
        <div className={`flex-1 ${isSidebarOpen ? 'md:ml-64' : ''} p-6`}>
          {children}
        </div>
      </div>
    </div>
