...
export default function PatientManagement() {
  ...
  // View patient details (old simple method)
  const handleViewPatient = (patient) => {
    ...
    try {
      // Show patient details in an alert (old method)
...
Age: ${patient.age || calculateAge(patient.dateOfBirth || patient.user?.dateOfBirth)}
Blood Group: ${patient.bloodGroup || 'N/A'}
Gender: ${patient.gender || 'N/A'}
Status: ${patient.user ? 'Active' : 'Inactive'}
      `;
      alert(patientInfo);
    } catch (error) {
