...
export default function ReportsPage() {
  ...
  const getStatusColor = (status) => {
    return status === 'new' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800';
  };
    ...
    <div className="space-y-6">
      ...
      <div className="border-b border-gray-200">
        <nav className="flex -mb-px space-x-8">
          {['all', 'new', 'lab', 'scan', 'prescription', 'other'].map((filter) => (
            <button
              key={filter}
            ...
            <div className="px-6 py-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-900">{selectedReport.reportId}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <span className={`mt-1 px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${getTypeColor(selectedReport.type)}`}>
                    {selectedReport.type}
                  </span>
                </div>
              </div>
                ...
                <div className="flex items-center justify-center h-64 bg-gray-200 rounded">
                  ...
                  <div className="text-center">
                    ...
                    <p className="mt-2 text-sm text-gray-500">
                      {selectedReport.type === 'Prescription' ? 'Prescription Document' : 'Report Document'}
                    </p>
